...
#Tratamento de possiveis erros no menu
if main.isdigit() == False:#Faz a verificação se é numero ou letra.
...
#Menu Adicionar pokemon
 if main == "1":
      ...
      elif main.isdigit() == True:#verifica se a opção esta entre 1 e 5.   
        if main > "5" or main < "1":
         print("Opção invalida! Escolha somente as opçoes no menu.")#caso a opção não esteja entre 1 e 5 imprime a menssagem e retorna ao menu.   
